...
const EditUser = () => {
  ...
  function handleSubmit() {
    ...
    showSnackbar({ type: 'success', message: 'Cập nhật người dùng thành công' });
  }

  function handleUpdatePassword() {
    actions.doChangePassword(password)(managementDispatch);
    showSnackbar({ type: 'success', message: 'Đổi mật khẩu thành công' });
  }
            ...
            <Box display={'flex'} flexDirection={'column'} width={600}>
              {tab === 0 ? (
                ...
                <>
                  ...
                  <Typography weight={'medium'}>Ảnh đại diện:</Typography>
                ...
                <>
                  ...
                  <FormControl variant='outlined' style={{ marginBottom: 35 }}>
                    <Select
                      ...
                      value={10}
                    >
                      <MenuItem value={10}>Tiếng Anh</MenuItem>
                      <MenuItem value={20}>Quản trị viên</MenuItem>
                      <MenuItem value={30}>Siêu quản trị</MenuItem>
                    </Select>
                  </FormControl>
                  <Typography weight={'bold'}>Liên lạc:</Typography>
                  <Box display={'flex'}>
                    <FormControlLabel
                      control={
