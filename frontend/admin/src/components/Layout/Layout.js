...
import Order from '../../pages/ecommerce/Orders'
import DiscountsPage from '../../pages/ecommerce/Discount'
    ...
    <div className={classes.root}>
      ...
      >
        ...
        <Switch>
          ...
          <Route exact path="/app/core" render={() => <Redirect url="/app/core/typography" />} />
          ...
          <Route exact path="/app/tables" render={() => <Redirect url={'/app/tables/static'} />} />
          <Route path="/app/tables/static" component={StaticTablesPage} />
          <Route path="/app/tables/dynamic" component={DynamicTablesPage} />

          <Route exact path="/app/ui" render={() => <Redirect url="/app/ui/icons" />} />
          ...
          <Route exact path="/app/forms" render={() => <Redirect url="/app/forms/elements" />} />
          <Route path="/app/forms/elements" component={FormsElements} />
          <Route path="/app/forms/validation" component={FormValidation} />

          <Route exact path="/app/charts" render={() => <Redirect url={'/app/charts/overview'} />} />
          ...
          <Route exact path="/app/maps" render={() => <Redirect url="/app/maps/google" />} />
          <Route path="/app/maps/google" component={MapsGoogle} />
          <Route path="/app/maps/vector" component={VectorMaps} />

          <Route exact path="/app/extra" render={() => <Redirect url="/app/extra/timeline" />}/>
          ...
          <Route path="/app/ecommerce/orders">
            <Order/>
          </Route>
          ...
          <Route path="/app/product-type/edit/:id" exact component={EditProductType}></Route>
