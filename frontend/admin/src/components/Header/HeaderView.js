...
const messages = [
  {
    ...
    variant: "warning",
    name: "Jane Hew",
    message: "Chào! Mọi việc thế nào rồi?",
    time: "9:32"
  },
  {
    id: 1,
    variant: "success",
    name: "Lloyd Brown",
    message: "Kiểm tra Dashboard mới của tôi nhé",
    time: "9:18"
  },
  {
    id: 2,
    variant: "primary",
    name: "Mark Winstein",
    message: "Tôi muốn sắp xếp lại lịch hẹn",
    time: "9:15"
  },
  {
    id: 3,
    variant: "secondary",
    name: "Liana Dutti",
    message: "Tin tốt từ bộ phận bán hàng",
    time: "9:09"
  }
];

const notifications = [
  { id: 0, color: "warning", message: "Kiểm tra ticket tuyệt vời này" },
  {
    id: 1,
    color: "success",
    type: "info",
    message: "Cách tốt nhất để nhận được..."
  },
  {
    id: 2,
    color: "secondary",
    type: "notification",
    message: "Đây chỉ là một thông báo đơn giản"
  },
  {
    id: 3,
    color: "primary",
    type: "e-commerce",
    message: "12 đơn hàng mới đã được tạo hôm nay"
  }
];
  ...
  <AppBar position="fixed" className={classes.appBar}>
    <Toolbar className={classes.toolbar}>
      ...
      >
        ...
        >
          <AccountIcon className={classes.profileMenuIcon} /> Trang cá nhân
        </MenuItem>
        <MenuItem
          className={classNames(
            classes.profileMenuItem,
        ...
        >
          <AccountIcon className={classes.profileMenuIcon} /> Công việc
        </MenuItem>
        <MenuItem
          className={classNames(
            classes.profileMenuItem,
        ...
        >
          <AccountIcon className={classes.profileMenuIcon} /> Tin nhắn
        </MenuItem>
        <div className={classes.profileMenuUser}>
          <Typography
            className={classes.profileMenuLink}
...
// ... (phần styles bên dưới giữ nguyên không đổi)
const styles = theme => ({
  logotype: {
    color: "white",
