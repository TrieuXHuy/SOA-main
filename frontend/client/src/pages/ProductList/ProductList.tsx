        ...
        {productsData && (
          <div className='grid grid-cols-12 gap-6'>
            ...
            <div className='col-span-9'>
              <SortProductList queryConfig={queryParams} pageSize={productsData.pagination.pageSize} />
              ...
              <Pagination queryConfig={queryParams} pageSize={productsData.pagination.pageSize} />
            </div>
          </div>
        )}
      </div>
