...
export default function ProductDetail() {
  ...
  const queryConfig: ProductListConfig = { limit: '20', page: '1', productTypeID: product?.productTypeID };
  ...
  const addToCart = () => {
    ...
    fetch(`${API_URL}/carts`, {
      ...
      body: new URLSearchParams({
        ...
        quantity: purchaseCount.toString()
      })
    })
      .then((res) => res.json())
      .then(() => {
  ...
  return (
    <div className='bg-gray-200 py-6'>
        ...
        <div className='bg-white p-4 shadow'>
          <div className='grid grid-cols-12 gap-9'>
            ...
            <div className='col-span-7'>
              <h1 className='text-xl font-medium uppercase'>{product.productName}</h1>
              ...
              <div className='mt-8 flex items-center bg-gray-50 px-5 py-4'>
                <div className='text-gray-500 line-through'>₫{formatCurrency(product.exportPrice)}</div>
                <div className='ml-3 text-3xl font-medium text-orange'>₫{formatCurrency(product.exportPrice * (1 - product.sale))}</div>
                <div className='ml-4 rounded-sm bg-orange px-1 py-[2px] text-xs font-semibold uppercase text-white'>
                  GIẢM {rateSale(product.exportPrice, product.exportPrice * (1 - product.sale))}
                </div>
              </div>
              <div className='mt-8 flex items-center'>
                ...
                <QuantityController
                  ...
                  max={product.view}
                />
                <div className='ml-6 text-sm text-gray-500'>{product.view} sản phẩm có sẵn</div>
              </div>
              <div className='mt-8 flex items-center'>
                <button
                  onClick={addToCart}
      ...
      <div className='mt-8'>
        <div className='container'>
          <div className='uppercase text-gray-400 font-medium'>CÓ THỂ BẠN CŨNG THÍCH</div>
          {productsData && (
