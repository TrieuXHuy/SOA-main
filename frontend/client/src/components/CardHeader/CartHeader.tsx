      ...
      <div className='bg-white py-6'>
        <div className='container'>
          <nav className='md:flex md:items-center md:justify-between'>
            <Link to={path.home} className='col-span-2 flex items-center gap-2'>
              <div>
              ...
              <div className='mx-4 h-6 w-[1px] bg-blue-400 md:h-8' />
              <div className='capitalize text-blue-400 md:text-xl'>Giỏ hàng</div>
            </Link>
            <form className='mt-3 md:mt-0 md:w-[50%]' onSubmit={onSubmitSearch}>
              <div className='flex rounded-sm border-2 border-blue-200'>
                <input
                  type='text'
                  ...
                  {...register('name')}
                />
                <button className='flex-shrink-0 rounded-sm bg-blue-300 py-2 px-8 hover:opacity-90'>
                  <svg
