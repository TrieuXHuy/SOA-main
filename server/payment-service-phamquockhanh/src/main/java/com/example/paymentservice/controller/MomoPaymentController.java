...
import com.example.paymentservice.model.MomoPaymentRequest;
...
public class MomoPaymentController {
    ...
    private static final String REDIRECT_URL = "http://localhost:3000/order";
    private static final String IPN_URL = "http://localhost:3000/order";
